...
Future<void> silentConfigExamSocial(
    BuildContext context, bool mounted, String fbExam) async {
  context.read<AppProvider>().setWait(true);

  String userExam = fbExam;
  ...
  final examRef = FirebaseFirestore.instance
      ...
      .doc(userExam)
      .withConverter(
        fromFirestore: (snapshot, _) => fb_exam.Exam.fromFirestore(snapshot, _),
